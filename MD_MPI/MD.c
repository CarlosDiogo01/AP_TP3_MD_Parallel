...
void runiters(MD *md, Particles *particulas){
  ...
  MPI_Allreduce(MPI_IN_PLACE,&particulas->fX[0],md->mdsize,MPI_DOUBLE,MPI_SUM,MPI_COMM_WORLD);
  MPI_Allreduce(MPI_IN_PLACE,&particulas->fY[1],md->mdsize,MPI_DOUBLE,MPI_SUM,MPI_COMM_WORLD);
  MPI_Allreduce(MPI_IN_PLACE,&particulas->fZ[2],md->mdsize,MPI_DOUBLE,MPI_SUM,MPI_COMM_WORLD);
